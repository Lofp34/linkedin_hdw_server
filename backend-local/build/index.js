...
const server = new Server({ name: "hdw-mcp", version: "0.1.0" }, {
    capabilities: {
...
// Ajout du serveur HTTP Express pour le frontend
const app = express();
...
app.listen(HTTP_PORT, () => {
    log(`Serveur HTTP Express lancé sur le port ${HTTP_PORT}`);
});
